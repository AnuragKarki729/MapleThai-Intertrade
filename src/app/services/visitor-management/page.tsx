...
/>
  ...
  <div
    ...
    style={{ backgroundImage: "url('/services/visitor-management/visitorHerobg.png')" }}
  ></div>
            ...
            <div className="grid md:grid-cols-4 gap-12 items-start">
              ...
              <div className="md:col-span-1 sticky top-24">
                ...
                >
                  ...
                  <div className="bg-transparent rounded-lg md:rounded-xl lg:rounded-2xl shadow-[0_0_15px_rgba(0,0,0,0.1)] p-2 sm:p-3 md:p-3 lg:p-4 xl:p-6 inline-block">
                      ...
                      {text.subServices.map((service, index) => (
                        ...
                        >
                          <button
                            ...
                            text-xs sm:text-sm md:text-sm lg:text-base bg-amber-700 text-black hover:bg-orange-90 shadow-lg hover:scale-105 hover:text-white cursor-pointer"
                          >
